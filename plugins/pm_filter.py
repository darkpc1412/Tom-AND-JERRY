...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                              InlineKeyboardButton("⚡ CHANNEL⚡", url="https://t.me/mnxmovies124"),
                              InlineKeyboardButton("🔰 JOIN GROUP 🔰", url="https://t.me/mnxmovies124")
                            ],[
                              InlineKeyboardButton("😈ᴅᴇᴠᴏʟᴏᴘᴇʀ😈", url="https://t.me/Justinvrgs")
                             ]
                            ]
                        )
                    )
        ...
        buttons = [[
   InlineKeyboardButton('❤️‍🔥Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ❤️‍🔥', url=f'https://t.me/MC_TOMANDJERRYBOT?startgroup=true')
                ],[
        ...
        buttons = [[
            InlineKeyboardButton('Follow ', url='https://t.me/mnxmovies124'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/Justinvrgs")
                  ]]
            reply_markup = InlineKeyboardMarkup(btn)
            await query.message.edit_text(
